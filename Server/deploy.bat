...
ssh -i %KEY% %HOST% -t "cd TubePicker; git fetch --all; git reset --hard origin/master; chmod +x /home/ubuntu/TubePicker/Server/run.sh; /home/ubuntu/TubePicker/Server/run.sh"
